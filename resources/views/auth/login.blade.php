        ...
        <div class="col-md-8">
            ...
            @php if(isset($_COOKIE['login_email']) && isset($_COOKIE['login_pass']))
                ...
                <div class="card-header">{{ __('Login') }}</div>
                 ...
                 @if(session('error'))
                     <div class="alert alert-danger text-center mt-3 alert-dismissible mb-3"style="width:90%; margin:auto;">
                    ...
                    @endif
                     ...
                     @if(session('success'))
                     <div class="alert alert-info text-center mt-3 alert-dismissible mb-3"style="width:90%; margin:auto;">
                     <button type="button" class="close" data-dismiss="alert">&times;</button>
